        ...
        const imageData = [
            {
                title: "Coneccta Sistemas",
                description: "Design que inspira confiança."
            },
            {
                title: "Radio FM",
                description: "Seu site 24 horas por dia."
            },
            {
                title: "Kleber Lago",
                description: "Tecnologia que conecta marcas e pessoas."
            },
            {
                title: "Fogos de Artifício",
                description: "Seu negócio visível, suas vendas em alta."
            },
            {
                title: "Socorristas em ação",
                description: "Mais que visitas, resultados."
            },
            {
                title: "Chaveiro",
                description: "Código inteligente, resultado real."
            },
            {
                title: "Jose Roberto",
                description: "Seu site, com identidade e impacto."
            }
        ];
